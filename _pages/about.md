...
My recent research focuses on pushing natural human-AI interaction, where models handle diverse user inputs and generate self-corrective, factual, and preference-aligned responses. Before this, my efforts were dedicated to developing cost-effective and trustworthy visual autonomous systems in our changing world.  Feel welcome to check out my [selected publications](https://tsunghan-wu.github.io/publications/) and [Resume](https://tsunghan-wu.github.io/files/Patrick_Wu_Resume.pdf) for more information.

## Service

Workshop Organizer: [MMFM@ICCV25/CVPR26](https://mmfm-workshop.github.io/)

Workshop Coordinator: 1st BAIR-NCKU Summer AI Workshop

Conference/Journal Reviewer: CVPR, ECCV, ICCV, NeurIPS, ICLR, ICML, BMVC, ICMR, TMM